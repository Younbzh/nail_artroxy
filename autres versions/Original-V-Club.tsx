  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="accueil" className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black mb-6 leading-none tracking-tighter relative" style={{
            ...
            <p className="text-2xl sm:text-3xl md:text-4xl font-black text-yellow-400 mb-4 uppercase tracking-wider" style={{
              wordBreak: 'break-word'
            }}>
              {siteConfig.hero.subtitle}
            </p>

            <p className="text-lg sm:text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed font-semibold" style={{
              wordBreak: 'break-word'
            }}>
            ...
            <div className="mb-12 relative">
              ...
              <div className="relative bg-gradient-to-r from-fuchsia-900/50 to-purple-900/50 backdrop-blur-sm rounded-lg p-6 sm:p-8 border-2 border-fuchsia-500">
                <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-yellow-400 mb-3" style={{
                  wordBreak: 'break-word'
                }}>
                  14 FÉVRIER 2026
                </p>
                ...
                <p className="text-base sm:text-lg text-fuchsia-400 font-bold uppercase tracking-wider" style={{
                  wordBreak: 'break-word'
                }}>Saint-Valentin • Soirée d'ouverture</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center items-stretch sm:items-center">
              ...
              >
                ...
                <div className="relative bg-gradient-to-r from-fuchsia-600 to-purple-600 text-white px-8 sm:px-10 md:px-12 py-5 sm:py-6 rounded-lg hover:from-fuchsia-700 hover:to-purple-700 transition-all font-black text-lg sm:text-xl md:text-2xl uppercase tracking-wider shadow-2xl flex items-center justify-center gap-3 break-all">
                  <Phone className="w-6 sm:w-7 h-6 sm:h-7 flex-shrink-0" />
                  <span className="break-all">{siteConfig.contact.phone}</span>
                </div>
              </a>
              <button 
                onClick={() => scrollToSection('ambiance')}
                className="bg-black text-white px-8 sm:px-10 md:px-12 py-5 sm:py-6 rounded-lg hover:bg-gray-900 transition-all font-black text-lg sm:text-xl md:text-2xl uppercase tracking-wider shadow-xl border-2 border-yellow-400 hover:border-fuchsia-400 flex items-center justify-center gap-3"
              >
                <Zap className="w-6 sm:w-7 h-6 sm:h-7 text-yellow-400" />
                Découvrir
              </button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-black via-fuchsia-950/20 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-5xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-400 mb-4 tracking-tighter" style={{
              wordBreak: 'break-word'
            }}>
              Les Chiffres
            </h2>
            <p className="text-xl sm:text-2xl font-bold text-yellow-400 uppercase tracking-wider" style={{
              wordBreak: 'break-word'
      ...
      <section id="ambiance" className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-5xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 via-purple-400 to-fuchsia-600 mb-6 tracking-tighter" style={{
              wordBreak: 'break-word'
            }}>
              {siteConfig.ambiance.title}
            </h2>
            <p className="text-xl sm:text-2xl font-bold text-yellow-400 mb-6 uppercase tracking-wide" style={{
              wordBreak: 'break-word'
            }}>
              {siteConfig.ambiance.subtitle}
            </p>
            <p className="text-lg sm:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed font-medium" style={{
              wordBreak: 'break-word'
            }}>
      ...
      <section id="musique" className="py-24 bg-gradient-to-b from-black via-purple-950/20 to-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-5xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-fuchsia-400 to-purple-600 mb-6 tracking-tighter" style={{
              wordBreak: 'break-word'
            }}>
      ...
      <section className="py-24 bg-black relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-5xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-yellow-400 mb-6 tracking-tighter" style={{
              wordBreak: 'break-word'
            }}>
              {siteConfig.complex.title}
            </h2>
            <p className="text-xl sm:text-2xl font-bold text-white mb-6 uppercase tracking-wide" style={{
              wordBreak: 'break-word'
            }}>
              {siteConfig.complex.subtitle}
            </p>
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto font-semibold" style={{
              wordBreak: 'break-word'
            }}>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-5xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-400 mb-12 sm:mb-16 text-center tracking-tighter" style={{
            wordBreak: 'break-word'
          }}>
            Infos Pratiques
          </h2>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-6xl sm:text-7xl font-black mb-6 sm:mb-8 tracking-tighter text-white" style={{
            wordBreak: 'break-word'
          }}>
            Réservez Maintenant
          </h2>
          <p className="text-2xl sm:text-3xl mb-10 sm:mb-14 font-bold text-yellow-300 uppercase tracking-wider" style={{
            wordBreak: 'break-word'
          }}>
          ...
          <a 
            href={`tel:${siteConfig.contact.phone.replace(/\s/g, '')}`}
            className="inline-flex items-center justify-center gap-3 sm:gap-4 bg-black text-white px-10 sm:px-12 md:px-16 py-6 sm:py-7 md:py-8 rounded-lg hover:bg-gray-900 transition-all font-black text-xl sm:text-2xl md:text-3xl uppercase tracking-wider shadow-2xl hover:shadow-3xl hover:scale-105"
            style={{ wordBreak: 'break-all' }}
          >
            <Phone className="w-8 sm:w-9 md:w-10 h-8 sm:h-9 md:h-10 flex-shrink-0" />
            <span style={{ wordBreak: 'break-all' }}>{siteConfig.contact.phone}</span>
          </a>
