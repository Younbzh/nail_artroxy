  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-900 via-pink-900 to-orange-900 text-white" style={{
      ...
      <section id="accueil" className="relative pt-40 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-7xl sm:text-8xl md:text-9xl lg:text-[12rem] xl:text-[14rem] font-black leading-none mb-12 tracking-wider relative break-words" style={{
            ...
            <div className="max-w-4xl mx-auto mb-12 relative">
              ...
              <div className="relative bg-black/60 backdrop-blur-sm border-2 border-cyan-400/50 p-6 sm:p-8 rounded-lg">
                <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-4 uppercase tracking-wider break-words" style={{
                ...
                <p className="text-base sm:text-lg md:text-xl font-bold text-cyan-300 tracking-wide leading-relaxed" style={{
            ...
            <div className="mb-16 relative">
              ...
              <div className="relative bg-gradient-to-r from-orange-900/50 via-pink-900/50 to-purple-900/50 backdrop-blur-md rounded-lg p-8 sm:p-10 md:p-12 border-2 border-orange-400 shadow-[0_0_40px_rgba(255,107,53,0.5)]">
                <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-4 uppercase tracking-wider break-words" style={{
                ...
                <p className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 break-words" style={{
                  textShadow: '0 0 20px rgba(255,255,255,0.5)'
                }}>🎤 Avec KGS en tête d'affiche</p>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl font-bold uppercase tracking-[0.2em] sm:tracking-[0.3em]" style={{
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center">
              ...
              >
                ...
                <div className="relative px-8 sm:px-10 md:px-14 py-5 sm:py-6 md:py-7 font-black text-lg sm:text-xl md:text-2xl uppercase tracking-wider text-white border-2 border-cyan-300 shadow-[0_0_40px_rgba(0,255,255,0.8)] group-hover:shadow-[0_0_60px_rgba(255,0,255,1)] transition-all flex items-center justify-center gap-3 sm:gap-4 break-all">
                  <Phone className="w-6 sm:w-7 md:w-8 h-6 sm:h-7 md:h-8 flex-shrink-0" />
              ...
              >
                ...
                <div className="relative px-8 sm:px-10 md:px-14 py-5 sm:py-6 md:py-7 font-black text-lg sm:text-xl md:text-2xl uppercase tracking-wider text-cyan-400 border-2 border-cyan-400 group-hover:border-magenta-400 group-hover:text-white transition-all flex items-center justify-center gap-3 sm:gap-4 shadow-[0_0_30px_rgba(0,255,255,0.5)]">
                  <Zap className="w-6 sm:w-7 md:w-8 h-6 sm:h-7 md:h-8" />
                  DÉCOUVRIR
                </div>
              </button>
            </div>
      ...
      <section className="py-32 relative overflow-hidden border-y-2 border-cyan-400/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-6xl sm:text-7xl md:text-8xl font-black mb-6 uppercase tracking-wider" style={{
              background: 'linear-gradient(to right, #00FFFF, #FF00FF)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
            ...
            <p className="text-xl sm:text-2xl font-bold text-orange-400 uppercase tracking-[0.15em] sm:tracking-[0.2em]" style={{
      ...
      <section id="ambiance" className="py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-6xl sm:text-7xl md:text-8xl font-black mb-8 uppercase tracking-wider" style={{
            ...
            <p className="text-2xl sm:text-3xl font-bold text-white mb-6 uppercase tracking-wide" style={{
              textShadow: '0 0 20px rgba(255,255,255,0.5)',
              wordBreak: 'break-word'
            }}>
      ...
      <section id="musique" className="py-32 relative border-y-2 border-magenta-400/30 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl sm:text-3xl font-bold uppercase tracking-wide" style={{
      ...
      <section className="py-32 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h2 className="text-6xl sm:text-7xl md:text-8xl font-black mb-20 text-center uppercase tracking-wider" style={{
            background: 'linear-gradient(to right, #00FFFF, #FF00FF)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
            filter: 'drop-shadow(0 0 40px rgba(0,255,255,0.7))',
      ...
      <section className="py-32 relative overflow-hidden border-t-2 border-cyan-400/30">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-7xl sm:text-8xl md:text-9xl font-black mb-12 tracking-wider uppercase" style={{
            background: 'linear-gradient(135deg, #00FFFF 0%, #FF00FF 50%, #FF6B35 100%)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
          ...
          <p className="text-3xl sm:text-4xl mb-16 font-bold uppercase tracking-[0.2em] sm:tracking-[0.3em]" style={{
            background: 'linear-gradient(to right, #FF6B35, #FF00FF)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
          ...
          <a 
            href={`tel:${siteConfig.contact.phone.replace(/\s/g, '')}`}
            className="relative inline-flex items-center justify-center gap-3 sm:gap-4 md:gap-6 group overflow-hidden"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 via-magenta-500 to-orange-500 opacity-100 animate-pulse"></div>
            <div className="relative px-8 sm:px-12 md:px-16 lg:px-20 py-6 sm:py-8 md:py-10 font-black text-xl sm:text-2xl md:text-3xl lg:text-4xl uppercase tracking-wider text-white border-2 border-cyan-300 shadow-[0_0_60px_rgba(0,255,255,1)] hover:shadow-[0_0_80px_rgba(255,0,255,1)] transition-all break-all">
              <Phone className="inline w-8 sm:w-10 md:w-12 h-8 sm:h-10 md:h-12 mr-2 sm:mr-3 md:mr-4" />
              <span className="break-all">{siteConfig.contact.phone}</span>
            </div>
          </a>
